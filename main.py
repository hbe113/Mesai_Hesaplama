...
class MesaiApp:
    ...
    def show_settings_view(self):
        ...
        quick_colors = ft.Row([
            ft.IconButton(icon=ft.Icons.CIRCLE, icon_color="#1A237E", on_click=lambda _: set_quick_color("#1A237E", "#00BFA5")),
            ft.IconButton(icon=ft.Icons.CIRCLE, icon_color="#2E7D32", on_click=lambda _: set_quick_color("#2E7D32", "#C6FF00")),
            ft.IconButton(icon=ft.Icons.CIRCLE, icon_color="#B71C1C", on_click=lambda _: set_quick_color("#B71C1C", "#FFD600")),
            ft.IconButton(icon=ft.Icons.CIRCLE, icon_color="#4A148C", on_click=lambda _: set_quick_color("#4A148C", "#EA80FC")),
            ft.IconButton(icon=ft.Icons.CIRCLE, icon_color="#37474F", on_click=lambda _: set_quick_color("#37474F", "#81D4FA")),
        ], alignment="center")
    ...
    def build_history_tab(self):
        ...
        for ay_data in aylar:
            ...
            toplam_para = ay_data[1]; toplam_dk = ay_data[2]
